// Authentic WhatsApp brand glyph (Simple Icons path). Extracted so every
// WhatsApp CTA on the site uses the same recognisable mark instead of
// lucide-react's generic MessageCircle chat bubble.
